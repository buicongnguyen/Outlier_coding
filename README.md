...
- `docs/c-programming.html`: expert C revision across language and memory model, dynamic memory, systems and low-level programming, performance, and libraries and tooling (40 terminology cards + 200 questions = 40 per section in four exam formats - single-answer, select-all-that-apply, arrange-in-order, code-insertion covering SIMD/volatile/mmap/alignment/atomics - including principal-level judgment questions).
